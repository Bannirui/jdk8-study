...
public interface SortedMap<K,V> extends Map<K,V> {
     ...
     *         of its keys
     */
    Comparator<? super K> comparator(); // key值比较器
     ...
     */
    SortedMap<K,V> subMap(K fromKey, K toKey); // [fromKey, toKey)之间的子map
     ...
     *         bounds of the range
     */
    SortedMap<K,V> headMap(K toKey); // (..., toKey)的子map
     ...
     *         bounds of the range
     */
    SortedMap<K,V> tailMap(K fromKey); // [fromKey, ...)子map
     ...
     *         sorted in ascending key order
     */
    Set<Map.Entry<K, V>> entrySet(); // 节点集合
}
